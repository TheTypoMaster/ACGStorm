...
class ControllerSaleContact extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->get['order_id']) && isset($this->request->get['user'])) {
            $order_id = $this->request->get['order_id'];
            $user = $this->request->get['user'];
            $this->load->model('sale/customer');
            $email = $this->model_sale_customer->getEmail($user);
            $this->data['title'] = "订单" . $order_id . "提示";
        ...
        if (isset($this->request->get['sid'])) {
            ...
            $product = $this->model_yundan_yundan->getOrder($sid);
            $this->data['title'] = "运单" . $sid . "提示";
            $this->data['email'] = $product[0]['email'];
        }
    ...
    public function send() {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            if (!$json) {
                ...
                if ($this->request->post['store_id'] == "notice") {
                    $customer_email = $this->request->post['order_email'];
                    ...
                    $emails[] = $this->request->post['order_email'];
                    if ($emails) {
                        $page = 1;
                        $email_total = 1;
                        $start = ($page - 1) * 10;
