...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getForm() {
        ...
        $this->data['entry_url_get'] = $this->language->get('entry_url_get');
        ...
        $this->data['entry_mpnurl'] = $this->language->get('entry_mpnurl');
        $this->data['entry_location'] = $this->language->get('entry_location');
        $this->data['entry_num_iid'] = $this->language->get('entry_num_iid');
        ...
        $this->data['tab_onekey'] = $this->language->get('tab_onekey');
        ...
        $this->data['empty_entry_url'] = $this->language->get('empty_entry_url');
        $this->data['error_entry_url'] = $this->language->get('error_entry_url');
        $this->data['price_warn'] = $this->language->get('price_warn');
        ...
        if (isset($this->request->post['api_json'])) {
            $this->data['api_json'] = $this->request->post['api_json'];
        } elseif (!empty($product_info)) {
            $this->data['api_json'] = $product_info['api_json'];
        } else {
            $this->data['api_json'] = '';
        }
        ...
        if (isset($this->request->post['sku'])) {
            $this->data['sku'] = base64_decode($this->request->post['sku']);
        } elseif (!empty($product_info)) {
            $this->data['sku'] = base64_decode($product_info['sku']);
        } else {
            $this->data['sku'] = '';
        }
        ...
        if (isset($this->request->post['mpnurl'])) {
            $this->data['mpnurl'] = $this->request->post['mpnurl'];
        } elseif (!empty($product_info)) {
        ...
        if (isset($this->request->post['num_iid'])) {
            $this->data['num_iid'] = $this->request->post['num_iid'];
        } elseif (!empty($product_info)) {
            $this->data['num_iid'] = $product_info['num_iid'];
        } else {
            $this->data['num_iid'] = '';
        }

        if (isset($this->request->post['location'])) {
            $this->data['location'] = urlencode($this->request->post['location']);
            $this->data['entry_url_value'] = $this->request->post['entry_url_value'];
        } elseif (!empty($product_info)) {
            $this->data['location'] = urldecode($product_info['location']);
            $this->data['entry_url_value'] = $product_info['location'];
        } else {
            $this->data['location'] = '';
            $this->data['entry_url_value'] = '';
        }
        ...
        $this->load->model('tool/image');
//echo "test".DIR_IMAGE . $product_info['image'];
        if (isset($this->request->post['image']) && file_exists(DIR_IMAGE . $this->request->post['image'])) {

            $this->data['thumb'] = $this->model_tool_image->resize($this->request->post['image'], 222, 222);
            // $this->data['thumb']=HTTPS_CATALOG . 'image/'.$this->request->post['image'];
            // echo "test1:".DIR_IMAGE . $this->request->post['image'];
        } elseif (!empty($product_info) && $product_info['image'] && file_exists(DIR_IMAGE . $product_info['image'])) {

            $this->data['thumb'] = $this->model_tool_image->resize($product_info['image'], 222, 222);
            //$this->data['thumb']=HTTPS_CATALOG . 'image/'.$product_info['image'];
            // echo "test2:".DIR_IMAGE . $product_info['image'];
        } else {


            $this->data['thumb'] = $this->model_tool_image->resize('no_image.jpg', 222, 222);
            // echo "test3:".$this->data['thumb'];
        }
        ...
        if (isset($this->request->post['frontpage'])) {
            $this->data['frontpage'] = $this->request->post['frontpage'];
        } elseif (!empty($product_info)) {
            $this->data['frontpage'] = $product_info['frontpage'];
        } else {
        ...
        /*
          elseif (!empty($data)) {
          $this->data['price'] = $data['good_price'];
          }
         */ else {
            $this->data['price'] = '';
        }
    ...
    /*     * ****
     * @函数功能：定义函数getinfo()用于通过淘宝API接口获取单件商品的信息详情
     * @param：   string $url  参数为该单件商品在淘宝网的链接网址
     * @return：  json  $data  返回该单件商品的信息详情
     * @author：  韦坤<wk@cnstorm.com>
     * ***** */

    //add by weikun 抓取商品信息
    public function getinfo() {
        ...
        if (false !== strpos($site, 'taobao.com') || false !== strpos($site, 'tmall.com')) {
            ...
            } else if (false !== strpos($site, 'tmall.com')) {
                //商城名
    ...
    public function clearCache() {
        if ($this->del_DirAndFile(DIR_SYSTEM . '/cache/pc/') || $this->del_DirAndFile(DIR_SYSTEM . '/cache/productcache/'))
