...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->data['text_cosplay_category'] = $this->language->get('text_cosplay_category');
		...
		$this->data['text_help_question'] = $this->language->get('text_help_question');
		$this->data['text_bulletin'] = $this->language->get('bulletin');
        ...
        $this->data['text_cosplay_product'] = $this->language->get('text_cosplay_product');
		...
		$this->data['text_yun_order'] = $this->language->get('text_yun_order');
		...
		$this->data['text_promotion_margen'] = $this->language->get('text_promotion_margen');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
            ...
            $this->data['cosplay_category'] = $this->url->link('catalog/cosplay_category', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['usertopup'] = $this->url->link('sale/usertopup', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['integral'] = $this->url->link('sale/integral', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['placeorder'] = $this->url->link('sale/placeorder', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['record'] = $this->url->link('record/record', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['rechargerecord'] = $this->url->link('record/rechargerecord', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['scorerecord'] = $this->url->link('record/scorerecord', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['rcrecord'] = $this->url->link('record/rcrecord', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['interaction'] = $this->url->link('interaction/interaction', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['consult'] = $this->url->link('interaction/consult', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['announcement'] = $this->url->link('interaction/interaction/announcement', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['pm'] = $this->url->link('interaction/pm', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['verification'] = $this->url->link('interaction/verification', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['commentshow'] = $this->url->link('community/commentshow', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['saiercomment'] = $this->url->link('community/saiercomment', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['theme'] = $this->url->link('community/theme', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['lunbo'] = $this->url->link('community/lunbo', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['orderForm'] = $this->url->link('report/orderForm', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['cosplay_product'] = $this->url->link('catalog/cosplay_product', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['reminder_email'] = $this->url->link('sale/reminder_email', 'token=' . $this->session->data['token'], 'SSL');
			
			$this->data['profile'] = $this->url->link('catalog/profile', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['favourable'] = $this->url->link('catalog/favourable', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['report_product_source'] = $this->url->link('report/product_source', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['maintain_area'] = $this->url->link('setting/maintain_area', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['maintain_delivery'] = $this->url->link('setting/maintain_delivery', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['help_category'] = $this->url->link('setting/help_category', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['help_question'] = $this->url->link('setting/help_question', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['help'] = $this->url->link('setting/help', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['bulletin'] = $this->url->link('setting/bulletin', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['yundan'] = $this->url->link('yundan/yundan', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['take_rates'] = $this->url->link('report/take_rates', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['sender_guojia'] = $this->url->link('report/sender_guojia', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['order_detail'] = $this->url->link('report/order_detail', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['promotion_margen'] = $this->url->link('promotion/promotion_margen', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['tixian_manage'] = $this->url->link('promotion/tixian_manage', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['commission'] = $this->url->link('promotion/commission', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['friends_manage'] = $this->url->link('promotion/friends_manage', 'token=' . $this->session->data['token'], 'SSL');
