    ...
    <table class="altrowstable">
       ...
       ?>
		...
		<td><?php echo $result['oids']?></td>
                ...
                <td>
	    <?php if ($result['addtime'] <= strtotime("2014-12-12 17:00:00")){ ?>
		
		<?php if(0 == $result['dabao']) {
                    echo "经济方案";
	  ...
	  <?php } ?>
        ...
        <tr >
          <td colspan="13" align="right">感谢阁下选择CNstorm，我们竭诚为您提供极致国际购物及运输体验!<br/>
