      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="right"><?php echo $column_register; ?></td>
			<td class="right"><?php echo $column_regorders; ?></td>
            <td class="right">转换比例</td>
          </tr>
        </thead>
        <tbody>
         ...
         <?php if ($orders) { ?>
          ...
          <tr>
            ...
            <td class="right"><?php echo $order['RegisterNum']; ?></td>
            <td class="right"><?php echo $order['orderNum']; ?></td>
            <td class="right"><?php echo $order['fruit']; ?></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
...
function filter() {
	url = 'index.php?route=report/take_rates&token=<?php echo $token; ?>';
