...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <table class="form">
        <tr>
          <td style="width:300"> <?php echo $entry_date_start; ?>
          ...
          <td>
           ...
           <?php for($i=1;$i<4;$i++){ ?>
              ...
              <option value="<?php echo $i; ?>"><?php echo $group[$i]; ?></option>
...
function filter() {
	url = 'index.php?route=report/sender_guojia&token=<?php echo $token; ?>';
