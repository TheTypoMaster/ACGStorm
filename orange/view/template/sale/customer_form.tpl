...
<?php //} ?></td>
              ...
              <tr>
                ...
                <td><input type="text" name="address[<?php echo $address_row; ?>][address_details]" value="<?php echo $address['address_details']; ?>" />
...
function addAddress() {	
    ...
    html += '      <td><input type="text" name="address[' + address_row + '][address_details]" value="" /></td>';
    html += '    </tr>';
    html += '    <tr>';
