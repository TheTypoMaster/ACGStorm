...
$_['text_head']								  = '用户中心-欢迎您来到CNstorm代购用户中心，查看代购订单情况';
$_['text_meta_keywords']					  = '用户中心，代购订单，自助购订单，转运订单，订单管理，仓储管理，运输管理，代购充值，优惠券，代寄订单';
$_['text_meta_description']					  = 'cnstorm代购用户中心为你提供查看或管理代购订单，自助购订单，转运订单，及时尊享CNstorm专业客服团队及完善的售后保障体系';
$_['text_procurement_orders']				  = '代购订单';
$_['text_by_id']							  = '按订单号';
$_['text_by_keywords']						  = '按关键字';
$_['text_search_placeholder']				  = '请输入关键字、订单号进行搜索';
$_['text_search_timerange']					  = '按时间范围搜索';
$_['text_startTime_placeholder']			  = '起始时间';
$_['text_endTime_placeholder']				  = '结束时间';
$_['text_search_keywords']					  = '按关键字搜索';
$_['text_mailable_order']					  = '可邮寄订单';
$_['text_all_order']						  = '全部订单';
$_['text_check_all']						  = '全选';
$_['text_store_title']						  = '店铺:';
$_['text_modify']							  = '修改';
$_['text_merge_pay']						  = '合并支付';
$_['text_product_img']						  = '产品图片';
$_['text_urged']							  = '已催促';
$_['text_urged_buy']						  = '采购催促';
$_['text_check_logistics']					  = '查看物流';
$_['text_requested_photo']					  = '已请求拍照';
$_['text_photograph_photo']					  = '订单拍照';
$_['text_check_agio']						  = '查询差价';
$_['text_pay_agio']							  = '补交差价';
$_['text_loading']							  = '加载中...';
$_['text_time_format']						  = '时间格式为2014-01-01形式';
$_['text_time_notnull']						  = '起始和终止时间都不能为空噢';
$_['text_keyword_format']					  = '订单号和关键字不能为空哦！';
$_['text_payagio_success']					  = '补交差价成功,请稍候自动刷新页面！^-^';
$_['text_payagio_failed1']					  = '抱歉，请联系我们的在线客服补交差价吧！^-^';
$_['text_payagio_failed2']					  = '余额不足，补交失败!';
$_['text_payagio_money']					  = '您需要补交的差价金额为人民币';
$_['text_payagio_failed3']					  = '不好意思，小C迷路了，请联系客服美眉查询吧！';
$_['text_failed']							  = '服务器繁忙，请稍后再试!';
$_['text_photo_request']					  = '拍照请求服务单张1元，确认后将为您提交申请。';
$_['text_photo_requested']					  = '已请求拍照';
$_['text_modify_success']					  = '修改成功';

$_['text_selfhelpbuy_orders']				  = '自助购订单';
$_['text_search_placeholder_k']				  = '请输入关键字进行搜索';
$_['text_search_placeholder_k']				  = '请输入关键字进行搜索';
$_['text_search']							  = '搜索';
$_['text_fillin_logistics']					  = '填写物流';
$_['text_select_express']					  = '请选择快递公司';
$_['text_express_no']						  = '物流单号：';
$_['text_submit']							  = '提交';
$_['text_fillin_nubmer']					  = '请输入数字单号！';
$_['text_info_close']						  = '关闭信息';

$_['text_fillin_logistics2']				  = '补填快递信息';

$_['text_mystore_head']						  = '我的仓库-欢迎您来到CNstorm代购用户中心';
$_['text_mystore_list']						  = '库存列表';
$_['text_mystore_address']					  = '仓库地址';
$_['text_package_info']						  = '包裹信息';
$_['text_order_no']							  = '订单编号';
$_['text_come_time']						  = '入库时间';
$_['text_weight']							  = '物品重量';
$_['text_sensitivity']						  = '敏感品';
$_['text_chosen']							  = '您已选取 ';
$_['text_chosen2']							  = ' 件商品，共计 ';
$_['text_create_waybill']					  = '生成国际运单';
$_['text_mystore_address2']					  = '我的仓库地址';
$_['text_mystore_introduction']				  = '自助购或者代寄的时候，请正确填写以上信息，确保仓库能及时收到您的货物。';
