...
$_['text_tags']           = '标签：';
$_['text_error']          = '此商品不存在！';
$_['text_payment_profile'] = '分期付款方式';

$_['text_domestic_freight'] = '国内运费：';
$_['text_origin_of_goods'] = '商品来源：';
$_['text_colors'] = '颜色分类：';
$_['text_sizes'] = '尺码分类：';
$_['text_goods_note'] = '商品备注：';

$_['text_trial_description'] = '每期%s，共%d期，每%d %s 付款%s every %d %s(s) for %d payment(s) then';
