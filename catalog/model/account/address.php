...
class ModelAccountAddress extends Model {
	public function addAddress($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$this->customer->getId() . "', firstname = '" . $this->db->escape($this->customer->getFirstName()) . "', lastname = '" . $this->db->escape($data['lastname']) . "', address_details = '" . $this->db->escape($data['address_details']) . "', postcode = '" . $this->db->escape($data['postcode']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', zone_id = '" . (int)$data['zone_id'] . "', country_id = '" . (int)$data['country_id'] . "'");
