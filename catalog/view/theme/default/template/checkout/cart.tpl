  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <div class="cart-info">
      <table>
        ...
        <tbody>
          <?php foreach ($storenamearray as $storeurl=>$storename) { ?>
       
          <tr>
             <td class="model"><?php echo $column_storename ?></td>
             <td class="model"><a target="_blank" href="<?php echo $storeurl;?>"><?php echo $storename; ?></a></td>
             <td class="model"></td>
             <td class="model"></td>
             <td class="model"></td>
             <td class="model"></td>
          ...
          <?php foreach ($products as $product) { ?>
            <?php if ($product['storename'] == $storename) {?>
          ...
          <tr>
            <td class="image" ><?php if ($product['thumb']) { ?>
              <a href="<?php echo $product['href']; ?>"><img style="height:50px;width:50px;" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a>
              <?php } ?></td>
            ...
            <td class="model"><?php echo $product['color']; ?></td>
            <td class="model"><?php echo $product['size']; ?></td>
