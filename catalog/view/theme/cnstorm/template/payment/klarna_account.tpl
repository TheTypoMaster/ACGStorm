    ...
    <table class="radio">
      ...
      <tr class="highlight">
        ...
        <td style="width: 1%;"><?php if ($iso_code_3 == 'NLD') { ?>
          <img src="catalog/view/theme/default/image/klarna_nld_banner.png" alt="banner"/>
          <?php } ?></td>
      </tr>
      <?php } ?>
    </table>
...
$('#button-confirm').on('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt="加载" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
