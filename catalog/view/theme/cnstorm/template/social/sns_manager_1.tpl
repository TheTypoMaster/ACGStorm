...
<div class='' >
        ...
        <div class="all_dingdan">
          <ul class="dingdan_list">
            ...
            <li><a href="<?php echo $reply_url; ?>"  class="on">给我回复       
       </a></li>
          ...
          <div class="dg_dingdan">
            <div style="padding:10px 20px;font-size:14px;border-bottom:1px #e5e5e5 solid">Hi，<?php echo $firstname; ?>，您发表的评论共收到 <span style="color:#ed5564;font-weight:bold"><?php echo $reply_total; ?></span> 条回复！</div>
            ...
            <div class="comment-list">
                  ...
                  <div class="com_img">
                  <?php if($reply['face']) {  ?>
                  <img src="<?php echo $reply['face']; ?>"/></div>
                  <?php }else{  ?>
                  <img src="uploads/big/0b4a96400b2372d25da769647bfe4059.jpg"/></div>
                  <?php } ?>
                  <div class="com_out_line" ></div>
                  <div class="com_text">
                      <div class="rp_title"><span class="re_user_name" style="color:#0c73c2;font-size: 14px;"><?php echo $reply['firstname'];  ?></span><span> 对我在对我的<?php if(1 == $reply['message_flag']) { ?>晒单<?php }else if(2 == $reply['message_flag']){ ?>心情<?php } ?> </span><span style="color:#0c73c2;font-size: 14px;" class="comment_content">“<?php if(strlen($reply['message_text']>108)) {echo substr_replace($reply['message_text'],"..." ,108); }else{  echo $reply['message_text']; }?>”</span><span> 的评论进行了回复： </span>
                          <p class="comment_content"><?php echo $reply['comment_text']; ?></p>
                      </div>
                          <div style="margin-top:14px;color:#a0a0a0"><span><?php echo date("Y-m-d H:i:s",$reply['addtime']);?></span><span style="float:right"><!--<a href="#" style="color:#0c73c2">查看对话</a>  <i style="color:#d8d8d8">|</i>-->  <a href="/index.php?route=social/comment&message_id=<?php echo $reply['message_id'];?>" class="com reply" id="<?php echo "re_".$reply['comment_id']; ?>" style="color:#0c73c2">回复</a></span></div>
