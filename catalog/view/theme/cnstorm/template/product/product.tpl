  ...
  <div class="product-info" >
    ...
    <div class="left" >
      ...
      <ul id="spec-list" style="list-style-type:none; padding:0px; width:260px; height:58px; padding-top:2px; overflow:hidden;">
           <?php if($item_imgs){
                  ...
                  {
           ?>
           <li style="float:left; margin-right:5px; margin-bottom:3px;border:1px solid #ccc;"><img alt="项目图片" height="50px" width="50px" src="<?php echo $item_img; ?>"/></li>
           <?php
                  }
           }
           ?>  
    ...
    <div class="right">
      ...
      <div class="cart"><?php echo $text_price; ?>
        ...
        <div class="cart"><?php echo  $text_domestic_freight; ?> <?php echo $isbn ?><br />
        </div>
        ...
        foreach($ean as $signal_ean) {?>
               <a onclick="click_color('<?php echo $signal_ean ?>')" style="color:#000;text-decoration:none;" id="<?php  echo str_replace(':','_',(array_keys($color_number,$signal_ean)[0]))?>"><li  style="border: 1px solid #CCCCCC; margin-right:3px; padding:8px; display:inline; white-space: nowrap;"><?php echo $signal_ean; ?></li></a> 
        <?php } } ?>
        ...
        <?php if($jan){
              foreach($jan as $signal_jan) {?>
               <a onclick="click_size('<?php echo $signal_jan?>')" style="color:#000;text-decoration:none;" id="<?php echo str_replace(':','_',(array_keys($size_number,$signal_jan)[0]))?>"><li  style="border: 1px solid #CCCCCC; display:inline; white-space: nowrap; margin-right:3px;padding:8px; "><?php echo $signal_jan; ?></li></a> 
        <?php } } ?>
        </ul>
        <br />        
        </div>
      ...
      <div class="review">
        ...
        <div><h2><?php echo $tab_description ?></h2>
        <ul style="list-style-type:none">
            <?php foreach($prop_imgs as $prop_img) { ?>
                <li><img atl="prop img" src=<?php echo $prop_img ?> /></li>
            <?php } ?> 
        </ul>
        </div>
      </div>
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt="加载" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
