...
<?php echo $uc_business; ?>
    <div class="content-right" style="height:800px">
      <div class="page-title"> <h2>待取消订单</h2><span class="faqs"> <a href="/help.html" class="link-faq" title="使用帮助">FAQ</a> </span></div>
      <div class="ui-box">
        <h3> 主要订单状态 </h3>
        <div class="ui-box-body">
          <div class="ui-form-item">
            <div class="ui-form-control">
              ...
              <a <?php if (isset($pass_order_status_id) &&  $pass_order_status_id == $order_status['order_status_id'])echo "class='dingdan_active'" ?> href="order-order.html&order_status_id=<?php echo $order_status['order_status_id']; ?>" ><?php echo $order_status['name']; ?> <font color="#FD522E">( <?php if ( isset($order_status['total']) ) echo $order_status['total']; ?> )</font></a>
              <?php }} ?>
            </div>
          </div>
          <div class="ui-form-item">
          ...
          <table class="zizhu_table" border="0" align="center" cellspacing="0" cellpadding="0">
            <tbody>
              <tr>
				...
				<?php if($order['order_status_buy']==1){ ?>
				代采购订单
                ...
                <td width="103" class="dt_quxiao" align="center">
				<ul>
