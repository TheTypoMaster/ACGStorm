<?php echo $header; ?>
<title>自助购订单列表 - CNstorm用户中心</title>
...
<div class="goods_details_bg">
  <div class="yhzx wrap">
    <div class="user_center"> <?php echo $column_left ;?>
      <div class=''>
        <div class="dl_head">
          <h3 class="bg1"><?php echo $text_selfhelpbuy_orders; ?></h3>
       ...
       (    <span class="num_zero">0</span>   )
       <?php } ?></a></li>
            <li><a class="on" href="javascript:void(0);"   ><?php echo $order_zigou;?>
                    <?php if($num_zizhu){ ?>
       ...
       <?php } ?>
            ...
            <li><a href="index.php?route=order/order/order_three" ><?php echo $order_daiji;?>
                    <?php if($num_daiji){ ?>
	   ...
	   <ul class="dingdan_status">
		<li><a <?php if (!isset($pass_order_status_id)) echo "class='dingdan_active'" ?> href="order-order-order_two.html&order_status_id=0" ><?php echo $text_all_order; ?><font color="#FD522E">( <?php echo $num_zizhu; ?> )</font></a></li>
		<?php foreach ($order_statuses as $order_status) { ?>
			<li><a <?php if (isset($pass_order_status_id) &&  $pass_order_status_id == $order_status['order_status_id'])echo "class='dingdan_active'" ?> href="order-order-order_two.html&order_status_id=<?php echo $order_status['order_status_id']; ?>" ><?php echo $order_status['name']; ?>
...
function searchOrderForTime(){
    ...
    if (!re.test(startTime) || !re.test(endTime)){
        ...
        window.location="order-order-order_two.html&st="+startTime+"&et="+endTime;
    }else{
...
function searchOrderForKeyWord(){
    ...
    if (searchKeyWord.trim('') != ''){
        if (si == 1){
            window.location="order-order-order_two.html&order_id="+searchKeyWord;
        }else if(si == 2){
            window.location="order-order-order_two.html&sk="+searchKeyWord;
        }
    }else{
