        ...
        <div class="dingdan0">
          <p class="dd_head">
            ...
            <?php } ?>
            <span class="dd_code"><em><?php echo $order_Number;?></em><?php echo $order['order_id'];?></span> <span class="dd_time"><em><?php echo $order_time;?></em><?php echo $order['date_added'];?></span> <span class="dd_code"><em><?php echo $text_store_title; ?></em></span> <a target="_blank" href="<?php echo $order['storeurl'];?>" >
			<span class="sho_n unknown" ><?php echo $order['storename'];?></span></a></p>
