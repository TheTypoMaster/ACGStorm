...
<div class="checkout_info">
  <div class="wrap">
    <div class="ship-box">
      ...
      <form action="index.php?route=checkout/confirm/sendorder2" method="post">
	  ...
	  <input type="hidden" name="sendorder_id" value="<?php echo $sendorder_id;?>">	
      <div class="billing_info">
      <h3>运单费用统计<i>请仔细核对您的各项费用,如有疑问請随时联系客户服务小组。</i></h3>
