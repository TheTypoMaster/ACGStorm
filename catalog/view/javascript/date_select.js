var calendar = {
    ...
    init: function (s) {
		...
		$("#_calendar").delegate("#_tdCal tr:gt(0) td[date!='']","mouseover",function(){
			$(this).css({"color":"#fff","background-color":"#fb6e52"});
		});
		$("#_calendar").delegate("#_tdCal tr:gt(0) td[date!='']","mouseout",function(){
