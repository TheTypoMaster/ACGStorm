var aspectRatio='4:3'; // ratio of the image
var x1=138; // x1 for the image selection start
var y1=25; // y1 for the image selection start
var x2=298; // x2 for the image selection start
var y2=168; // y2 for the image selection start
...
var bigWidthPrev=398; // 
var bigHeightPrev=248;
...
function preview(img, selection) {
	...
	$('#preview img').css({'width':selection.width+'px','height':selection.height+'px','left':'-'+selection.x1+'px','top':'-'+selection.y1+'px'});
}