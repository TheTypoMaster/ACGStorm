...
$(function() {
    ...
    $('.zhifu_list li').click(function() {
        ...
        $('.paylist').eq($(this).index()).show()

                .siblings('.paylist').hide();
    ...
    $('.gw_intro_list li').click(function() {
        ...
        $('.cloth_list').eq($(this).index()).show()

                .siblings('.cloth_list').hide();
    ...
    $('.dc_tab .all_company li.cl_li').hover(function() {
        ...
        $('.dc_tab .company_details').eq($(this).index()).show()

                .siblings('.dc_tab .company_details').hide();
    ...
    $('.tw_tab .all_company li').hover(function() {
        ...
        $('.tw_tab .company_details').eq($(this).index()).show()

                .siblings('.tw_tab .company_details').hide();
    ...
    $('.all_tools li').click(function() {
        ...
        $('.tools_cont').eq($(this).index()).show()

                .siblings('.tools_cont').hide();
    ...
    $('.websites_tap li').click(function() {
        ...
        $('.cur_shop').eq($(this).index()).show()

                .siblings('.cur_shop').hide();
    ...
    $('.dingdan_list li').click(function() {
        ...
        $('.dg_dingdan,.dg_package_list,.save_box,.basic_informs,.wm_tables').eq($(this).index()).show()

                .siblings('.dg_dingdan,.dg_package_list,.save_box,.basic_informs,.wm_tables').hide();
    ...
    $(".num-pallets-input").each(function(i) {
        ...
        $(".click_add").eq(i).click(function() {
            var num = t.eq(i).val();
			var total=$('.kucun').children('span').attr('alt');
    ...
    $('#dual11-button-search').bind('click',
            function() {
...
* time:2015-05-22
* 头部搜索框
* 为“代购”“自助购”“代寄”“站内搜索”这4个table各自创建独有的提示文字和按钮文字
*/
var search = $("#search");
var button_search = $("#button-search");
var datahref=$("#searchUl li");
button_search.attr("value","我要代购");
search.attr("placeholder","粘贴您想购买的中国购物网站的商品地址（URL)");
datahref.click(function(){
	...
	switch($(this).index()){
		...
		case 1:
		search.attr("placeholder","粘贴您想购买的中国购物网站的商品地址（URL)");
		button_search.attr("value","我要自助购");
		break;
		case 2:
		search.attr("placeholder","请输入您要邮寄的国外地址");
		button_search.attr("value","我要代寄");
		break;
		case 3:
		search.attr("placeholder","请输入要搜索的商品名称");
		button_search.attr("value","我要搜索");
		break;
		default:
		search.attr("placeholder","粘贴您想购买的中国购物网站的商品网址（URL)");
		break;
	}
});
