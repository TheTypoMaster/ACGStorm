...
window.onload = function() {
   ...
   //var checkInputs=document.getElementsByClassName('on2');

    var checkAllInputs = $('.check-all'); // 全选框
    var selectedTotal = document.getElementById('product_all'); //已选商品数目容器
    var deleteAll = document.getElementById('gs_del'); // 删除全部按钮
    var priceTotal = document.getElementById('allPr'); //总计
    var freightTotal = document.getElementById('postAge_all'); //总运费
    ...
    function getTotal() {
        ...
        for (var i = 0; i < tr.length; i++) {
            ...
            var freight0 = parseFloat(tr[i].getElementsByTagName('em')[0].innerHTML);
        ...
        selectedTotal.innerHTML = $(".on2").length;
    ...
    // 点击选择框
//        $(document).delegate(".gwc_choos1", "click", function() {
...
//        });
    ...
    for (var i = 0; i < selectInputs.length; i++) {
      ...
      $('.check')[i].onclick = function() {
            ...
            }else if (this.className.indexOf('gwc_choos') >= 0){
                $(this).parent().find('label')[0].attr("class","check_label on");
                $(this).parent().parent().parent().parent().attr("class","bundles on2");
               // this.parentNode.getElementsByTagName('label')[0].className = "check_label on";
               //this.parentNode.parentNode.parentNode.parentNode.className = "bundles on2";
            }
            if (!this.checked) { //只要有一个未勾选，则取消全选框的选中状态
                ...
                $(this).parent().parent().parent().parent().parent().parent().find('.shop_check').checked = false;
                //shop_All.getElementsByClassName('shop_check').checked = false;
                shop_All.getElementsByTagName('label')[0].className = 'check_label';
                if (this.className == "gwc_choos1 check") {
