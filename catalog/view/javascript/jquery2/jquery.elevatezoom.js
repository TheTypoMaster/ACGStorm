...
(function( $, window, document, undefined ) {
	var ElevateZoom = {
			init: function( options, elem ) {
				...
				$('#'+self.options.gallery + ' a').hover( function(e) {             //2014-05-24将click改为Hover by jodie liu
...
//						and on mouseleave check if scrolllock          
        ...
        if(!self.options.zoomEnabled){return false;}
			...
			setWindowPostition: function( e ) {
				...
				self.zoomWindow.css({ top: self.windowOffsetTop-4});
				self.zoomWindow.css({ left: self.windowOffsetLeft+10});
