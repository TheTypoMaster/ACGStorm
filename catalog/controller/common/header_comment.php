...
class ControllerCommonHeaderComment extends Controller {
    ...
    protected function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/header_comment.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/common/header_comment.tpl';
        } else {
            $this->template = 'default/template/common/header_comment.tpl';
        }
