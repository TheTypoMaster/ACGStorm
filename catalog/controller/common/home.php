...
class ControllerCommonHome extends Controller {
    ...
    public function index() {
        ...
        $order_product_info = $this->model_order_order->getNewProductInfo(15);
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/newHome.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/common/newHome.tpl';
        } else {
            $this->template = 'default/template/common/newHome.tpl';
        }
        $this->children = array(
            'common/footer',
