...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        $product_info = $this->model_catalog_product->getProduct($product_id);//产品信息
        ...
        if ($product_info) {
            ...
            $discounts = $this->model_catalog_product->getProductDiscounts($this->request->get ['product_id']);//商品折扣
         ...
         /*   $product_options=$this->model_catalog_product->getProductOptions($this->request->get ['product_id']) ;//暂时无用
           ...
           // $this->data ['attribute_groups'] = $this->model_catalog_product->getProductAttributes($this->request->get ['product_id']);//暂时无用 guanzhiqiang 20150626
            ...
            $results = $this->model_catalog_product->getProductRelated($this->request->get ['product_id']);//产品信息
//dump($results);
         ...
         //   $this->data ['profiles'] = $this->model_catalog_product->getProfiles($product_info ['product_id']); //无数据无用 guanzhiqiang 20150626
            ...
            $this->model_catalog_product->updateViewed($this->request->get ['product_id']);//更新访问量

            $this->data ['product_category'] = $this->model_catalog_category->getProductCategory($this->request->get ['product_id']);//产品分类 guanzhiqiang 20150626
