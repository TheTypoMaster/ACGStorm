...
class ControllerProductSearch extends Controller { 	
	public function index() { 
        ...
        $cresults = $this->model_catalog_category->getCategories();
                 ...
                 if($s_results)
                 {
                     ...
                     {  
                        $this->data['s_categoryids'][] = array(
                           ...
                           'href' => $this->url->link('product/types', 'path=' . $result['category_id']."_".$s_result['category_id'])
        ...
        //var_dump(strcmp($search,'请输入淘宝购物网站网站商品的地址'));
        ...
        {
            if(!strcmp($search,'请输入淘宝购物网站网站商品的地址'))
                $this->data['name'] = '搜索内容';
            else
