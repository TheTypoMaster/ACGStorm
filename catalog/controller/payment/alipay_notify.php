...
class alipay_notify {
    ...
    function alipay_notify($partner,$key,$sign_type,$_input_charset = "utf-8",$transport= "https") {
    ...
    function notify_verify() {
		...
		if(empty($_POST)) {
			...
			//д��־��¼
            //log_result("weikun-kennewei".($this->mysign == $_POST['sign']));
            //log_result("weikun-kennewei".(preg_match("/true$/i",$veryfy_result)));
            //log_result("weikun------".(preg_match("/true$/i",$veryfy_result) && $this->mysign == $_POST['sign']));
	...
	*return ��֤���true/false
    ...
    function return_verify() {
		...
		if(empty($_GET)) {							//�ж�GET���������Ƿ�Ϊ��
            ...
            log_result("weikun".preg_match("/true$/i",$veryfy_result) && $this->mysign == $_GET["sign"]);
